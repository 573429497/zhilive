...
*/
    ...
    if(mark%shesu==0){
            // bullets.push(new oddbullet(parseInt(selfplan.imagenode.style.left)+60,parseInt(selfplan.imagenode.style.top)-10));
            // bullets.push(new oddbullet(parseInt(selfplan.imagenode.style.left)+50,parseInt(selfplan.imagenode.style.top)-10));
            // bullets.push(new oddbullet(parseInt(selfplan.imagenode.style.left)+30,parseInt(selfplan.imagenode.style.top)-10));
            // bullets.push(new oddbullet(parseInt(selfplan.imagenode.style.left)+10,parseInt(selfplan.imagenode.style.top)-10));
            // bullets.push(new oddbullet(parseInt(selfplan.imagenode.style.left)+0,parseInt(selfplan.imagenode.style.top)-10));
            if (dandao ==1) {
                bullets.push(new oddbullet(parseInt(selfplan.imagenode.style.left)+30,parseInt(selfplan.imagenode.style.top)-10));
            }else if (dandao == 2) {
                bullets.push(new oddbullet(parseInt(selfplan.imagenode.style.left)+20,parseInt(selfplan.imagenode.style.top)-10));
                bullets.push(new oddbullet(parseInt(selfplan.imagenode.style.left)+40,parseInt(selfplan.imagenode.style.top)-10));
            }else if (dandao == 3) {
                bullets.push(new oddbullet(parseInt(selfplan.imagenode.style.left)+10,parseInt(selfplan.imagenode.style.top)-10));
                bullets.push(new oddbullet(parseInt(selfplan.imagenode.style.left)+30,parseInt(selfplan.imagenode.style.top)-10));
                bullets.push(new oddbullet(parseInt(selfplan.imagenode.style.left)+50,parseInt(selfplan.imagenode.style.top)-10));
            }else if (dandao == 4) {
                bullets.push(new oddbullet(parseInt(selfplan.imagenode.style.left)+5,parseInt(selfplan.imagenode.style.top)-10));
                bullets.push(new oddbullet(parseInt(selfplan.imagenode.style.left)+25,parseInt(selfplan.imagenode.style.top)-10));
                bullets.push(new oddbullet(parseInt(selfplan.imagenode.style.left)+45,parseInt(selfplan.imagenode.style.top)-10));
                bullets.push(new oddbullet(parseInt(selfplan.imagenode.style.left)+65,parseInt(selfplan.imagenode.style.top)-10));
            }else if (dandao == 5) {
                bullets.push(new oddbullet(parseInt(selfplan.imagenode.style.left)+-10,parseInt(selfplan.imagenode.style.top)-10));
                bullets.push(new oddbullet(parseInt(selfplan.imagenode.style.left)+10,parseInt(selfplan.imagenode.style.top)-10));
                bullets.push(new oddbullet(parseInt(selfplan.imagenode.style.left)+30,parseInt(selfplan.imagenode.style.top)-10));
                bullets.push(new oddbullet(parseInt(selfplan.imagenode.style.left)+50,parseInt(selfplan.imagenode.style.top)-10));
                bullets.push(new oddbullet(parseInt(selfplan.imagenode.style.left)+70,parseInt(selfplan.imagenode.style.top)-10));
            }else if (dandao == 6) {
                bullets.push(new oddbullet(parseInt(selfplan.imagenode.style.left)+-25,parseInt(selfplan.imagenode.style.top)-10));
                bullets.push(new oddbullet(parseInt(selfplan.imagenode.style.left)+-5,parseInt(selfplan.imagenode.style.top)-10));
                bullets.push(new oddbullet(parseInt(selfplan.imagenode.style.left)+15,parseInt(selfplan.imagenode.style.top)-10));
                bullets.push(new oddbullet(parseInt(selfplan.imagenode.style.left)+35,parseInt(selfplan.imagenode.style.top)-10));
                bullets.push(new oddbullet(parseInt(selfplan.imagenode.style.left)+55,parseInt(selfplan.imagenode.style.top)-10));
                bullets.push(new oddbullet(parseInt(selfplan.imagenode.style.left)+75,parseInt(selfplan.imagenode.style.top)-10));
            }else if (dandao == 7) {
                bullets.push(new oddbullet(parseInt(selfplan.imagenode.style.left)+-30,parseInt(selfplan.imagenode.style.top)-10));
                bullets.push(new oddbullet(parseInt(selfplan.imagenode.style.left)+-10,parseInt(selfplan.imagenode.style.top)-10));
                bullets.push(new oddbullet(parseInt(selfplan.imagenode.style.left)+10,parseInt(selfplan.imagenode.style.top)-10));
                ...
                bullets.push(new oddbullet(parseInt(selfplan.imagenode.style.left)+50,parseInt(selfplan.imagenode.style.top)-10));
                bullets.push(new oddbullet(parseInt(selfplan.imagenode.style.left)+70,parseInt(selfplan.imagenode.style.top)-10));
                bullets.push(new oddbullet(parseInt(selfplan.imagenode.style.left)+90,parseInt(selfplan.imagenode.style.top)-10));
            }
...
var dandao = 1
function dandaojia(){
    var dandaomun = document.querySelector('#dandaomun')
    if (dandao >= 7) {
        return false
    }
    dandao++
    dandaomun.innerHTML = dandao
}
function dandaojian(){
    var dandaomun = document.querySelector('#dandaomun')
    if (dandao <= 1) {
...
function jia(){
    var mun = document.querySelector('#mun')
    if (shesu1 >= 4) {
        return false
    }
    shesu--
    shesu1++
    mun.innerHTML = shesu1
}
function jian(){
    var mun = document.querySelector('#mun')
    if (shesu1 <= 1) {
