...
(function () {
  ...
  String.format ||
    (String.format = function () {
      ...
      for (
        var a = arguments[0] || "", c, i = 1, v = arguments.length;
        i < v;
        i++
      )
        (c = RegExp("\\{" + (i - 1) + "\\}", "gm")),
          (a = a.replace(c, arguments[i]));
      return a;
    });
  String.getByteLength ||
    (String.getByteLength = function (a) {
      for (var c = 0, i = a || "", v = i.length, a = 0; a < v; a++)
        c = (0 <= i.charCodeAt(a)) & (255 >= i.charCodeAt(a)) ? c + 1 : c + 2;
      return c;
    });
  if (!Array || !Array.prototype) Array.prototype = {};
  Array.prototype.indexOfAttr = function (a, c) {
    for (
      var i = (typeof a).toLowerCase(), v = -1, b = 0, d = this.length;
      b < d;
      b++
    )
      if (
  ...
  var j = "linkScreen",
    ...
    l = {
      getCanvasDom: function () {
        fa || (fa = m.getDom("linkScreen"));
        return fa;
      },
      getOffsetX: function (a) {
        return (
          a.offsetX ||
          (a.targetTouches && a.targetTouches[0]
            ? a.targetTouches[0].clientX - l.getCanvasDom().offsetLeft
            : a.clientX - l.getCanvasDom().offsetLeft) ||
          0
        );
      },
      getOffsetY: function (a) {
        return (
          a.offsetY ||
          (a.targetTouches && a.targetTouches[0]
            ? a.targetTouches[0].clientY - l.getCanvasDom().offsetTop
            : a.clientY - l.getCanvasDom().offsetTop) ||
          0
        );
      },
      keydown: function (a) {
        ...
        d.keyUpGo && void 0 != d.lastKey[c] && (d.lastKey[c] = !1);
        d.keyPressCtrl[c] &&
          d.keyPressedGo &&
          (void 0 != d.pressedKey[c] && (d.pressedKey[c] = !0),
          (d.keyPressCtrl[c] = !1));
      ...
      keyup: function (a) {
        ...
        d.keyPressedGo &&
          (void 0 != d.pressedKey[c] && (d.pressedKey[c] = !1),
          (d.keyPressCtrl[c] = !0));
        null != d.keyUpCallBack && d.keyUpCallBack(a);
      },
      orientationchange: function (a) {
        null != d.orientationChange && d.orientationChange(a);
      },
      ...
      click: function (a) {
        null != d.clickCallBack &&
          d.clickCallBack(a, l.getOffsetX(a), l.getOffsetY(a));
      },
      mouseDown: function (a) {
        null != d.mouseDownCallBack &&
          d.mouseDownCallBack(a, l.getOffsetX(a), l.getOffsetY(a));
      },
      mouseUp: function (a) {
        null != d.mouseUpCallBack &&
          d.mouseUpCallBack(a, l.getOffsetX(a), l.getOffsetY(a));
      },
      mouseMove: function (a) {
        null != d.mouseMoveCallBack &&
          d.mouseMoveCallBack(a, l.getOffsetX(a), l.getOffsetY(a));
      },
      pageFocus: function (a) {
        if (d.focused) return (d.focused = !1);
      ...
      getDeviceConfig: function () {
        ...
        return -1 != a.indexOf("duopaosafari")
          ...
          : -1 != a.indexOf("msie")
          ? { device: "ie", fps: 0.5, touch: !1, zoom: 1 }
          : -1 != a.indexOf("windows")
          ? { device: "ie", fps: 0.5, touch: !1, zoom: 1 }
          : -1 != a.indexOf("safari")
      ...
      setImage: function (a, c, i, v, b) {
        ...
        u[a] ||
          ...
          (u[a].onload = function () {
            ...
            this.cache &&
              m.canvas
                .pass(this.id, this.width, this.height)
      ...
      loadingCallBack: function (a, c, i) {
        var v = m.canvas.screen.getWidth(),
          b = m.canvas.screen.getHeight(),
          d = parseInt((v - v) >> 1),
          e = b - 5,
          a = a > c ? c : a,
          ia = parseInt(100 * (a / c)) + "%";
        m.canvas
          ...
          .fillRect(0, 0, v, b)
          .fillStyle("#00FFFF")
          .fillRect(d, e, parseInt((a / c) * v), 5)
          .fillStyle("#FFF")
          .fillText("loading " + i, 5, b - 10)
          .fillText(ia, v - m.canvas.measureText(ia).width - 5, b - 10);
      },
      ...
      link =
        {
          ...
          ajax: function (a) {
            a && r.pool.length < r.poolLength && r.pool.push(a);
            a && a.clear && (r.pool = []);
            r.xhr ||
            ...
            if (null == r.xhrObj && 0 < r.pool.length) {
              ...
              r.date = setTimeout(function () {
                ...
                r.isTimeout = !0;
                r.xhrObj &&
                  (r.xhrObj.error(r.xhrObj, "timeout"), (r.xhrObj = null));
              }, r.xhrObj.timeout);
            }
            return this;
          },
              ...
              if (null != (d = arguments[c]))
                for (var e in d) {
                  var h = a[e],
                    g = d[e];
                  a !== g &&
                    (b && g && "object" === typeof g && !g.nodeType
                      ? (a[e] = this.objExtend(
                          b,
                          h || (null != g.length ? [] : {}),
                          g
          ...
          clone: function (a) {
            ...
            if ("object" == typeof c)
              if (void 0 != c.length)
                for (var a = [], i = 0, b = c.length; i < b; i++)
                  void 0 !== c[i] &&
                    (a[i] =
                      null != c[i] && "object" == typeof c[i]
                        ? void 0 != c[i].length
                          ? c[i].slice(0)
                          : c[i]
                        : c[i]);
          ...
          comm: {
            ...
            rangeRegisterNotify: function (a, c) {
              for (var i = 0; i < c.length; i++)
                m.commandFuns.registerNotify(a, c[i]);
            },
            ...
            rangeUnRegisterNotify: function (a, c) {
              for (var i = 0; i < c.length; i++)
                m.commandFuns.unRegisterNotify(a, c[i]);
            },
            getRandom: function (a, c) {
              if (c) return Math.round(Math.random() * (c - a) + a);
              var i = a;
              if (!i || 0 > i) i = 0;
            ...
            collision: function (a, c, i, b, d, e, g, h) {
              return g &&
                Math.abs(a + parseInt(i / 2) - (d + parseInt(g / 2))) <
                  parseInt((i + g) / 2) &&
                Math.abs(c + parseInt(b / 2) - (e + parseInt(h / 2))) <
                  parseInt((b + h) / 2)
                ? !0
                : !1;
            },
            ...
            createPath: function (a, c, i, b, d) {
              for (
                var e = [],
                  a = (i || 0) - (a || 0),
                  g = (b || 0) - (c || 0),
                  c = Math.sqrt(Math.pow(a, 2) + Math.pow(g, 2)),
                  b = (d = d || 5),
                  h = (i = 0),
                  f = 180 * (Math.atan2(g, a) / Math.PI),
                  f = 0 <= f ? f : f + 360;
                b < c + d;

              )
                (b = b > c ? c : b),
                  (a = b * Math.cos((f / 180) * Math.PI)),
                  (g = b * Math.sin((f / 180) * Math.PI)),
                  e.unshift([a - i, g - h]),
                  (i = a),
                  (h = g),
                  (b += d);
            ...
            null == f.pageLoad &&
              ...
              window.addEventListener(
                ...
                function () {
                  ...
                  a &&
                    (m.canvas.screen.getTouch()
                      ? (window.addEventListener(
                          "orientationchange",
                          l.orientationchange,
                          !1
                        ),
                        a.addEventListener("touchstart", l.touchstart, !1),
                        a.addEventListener("touchend", l.touchend, !1),
                        a.addEventListener("touchmove", l.touchmove, !1),
                        a.addEventListener("touchcancel", l.touchcancel, !1))
                      : ((document.onkeydown = l.keydown),
                        (document.onkeyup = l.keyup),
                        a.addEventListener("click", l.click, !1),
                        a.addEventListener("mousedown", l.mouseDown, !1),
                        a.addEventListener("mouseup", l.mouseUp, !1),
                        a.addEventListener("mousemove", l.mouseMove, !1)));
                  a = m.canvas.screen.getDevice();
                  "ipad" == a || "iphone" == a
                    ? ((d.focused = !0),
                      window.addEventListener("pageshow", l.pageFocus, !1),
                      window.addEventListener("pagehide", l.pageUnFocus, !1))
                    : ("firefox" == a && (d.focused = !0),
                      window.addEventListener("focus", l.pageFocus, !1),
                      window.addEventListener("blur", l.pageUnFocus, !1));
                  m.canvas
                    .fillStyle("#000")
                    .fillRect(
                      0,
                      0,
                      m.canvas.screen.getWidth(),
                      m.canvas.screen.getHeight()
                    );
                  X = !1;
          ...
          play: function () {
              ...
              (f.run = function () {
                ...
                switch (f.gameFlow) {
                  ...
                  case z.loadImage:
                    ...
                    break;
                  case z.loadedImage:
                    (f.gameFlow = f.loadedImageToGameFlow),
                      (F = []),
                      (q = 0),
                      X || l.pageLoaded();
                }
            ...
            f.playTimer ||
              ...
              (f.rafRun = function () {
                var a = Date.now();
                a - f.lastDate >= f.timeout - f.spendTime &&
                  ((f.lastDate = a), f.isPause || f.run());
          ...
          pause: function () {
            f.playTimer &&
              ((f.isPause = !0),
              (f.rafRun = null),
              cancelAnimationFrame(f.playTimer),
              (f.playTimer = null));
            return this;
          },
          gameFlow: {
            ...
            run: function () {
              null != f.runFn && ((f.gameFlow = z.run), m.resetKeys());
              return this;
            },
            stop: function () {
            ...
            zone: function (a) {
              null != f.zone &&
                ((f.gameFlow = z.zone), (f.zoneArgs = a), m.resetKeys());
              return this;
            },
            active: function (a) {
              null != f.active &&
                ((f.gameFlow = z.active), (f.activeArgs = a), m.resetKeys());
              return this;
            },
            isIn: function (a) {
          ...
          resetKeys: function () {
            ...
            for (a in d.keyPressCtrl) d.keyPressCtrl[a] = !0;
            return this;
          },
          canvas: {
            init: function () {
            ...
            pass: function (a, c, i) {
              ...
              E[a] ||
                ((b =
                  this.base().getDom(a) || document.createElement("canvas")),
                (E[a] = null),
                delete E[a],
                (E[a] = b.getContext("2d")),
                (b.width = c ? c : s),
                (b.style.width = parseInt(b.width * x) + "px"),
                (b.height = i ? i : t),
                (b.style.height = parseInt(b.height * x) + "px"),
                (w[a] = null),
                delete w[a],
                (w[a] = b));
              k = E[a];
            ...
            drawImage: function (a, c, i, b, d, e, g, h, f, q) {
              var j = m.getImage(a);
              if (j.refreshed) this.drawCache(a, c, i, b, d, e, g, h, f, q);
              else if (null != j.src)
                null != h && ((c = 0 > c ? 0 : c), (h = 0 >= h ? 0.1 : h)),
                  null != f && ((i = 0 > i ? 0 : i), (f = 0 >= f ? 0.1 : f)),
                  null != b &&
                    null != h &&
                    (b = 0 >= b ? 0.1 : c + b <= j.width ? b : j.width - c),
                  null != d &&
                    null != f &&
                    (d = 0 >= d ? 0.1 : i + d <= j.height ? d : j.height - i),
                  j.loaded &&
                    (b
                      ? d
                        ? q
                          ? ((G = l.getAnchor(e, g, h, f, q)),
                            k.drawImage(j, c, i, b, d, G.x, G.y, h, f))
                          : k.drawImage(j, c, i, b, d, e, g, h, f)
                        : ((G = l.getAnchor(c, i, j.width, j.height, b)),
                          k.drawImage(j, G.x, G.y))
                      : k.drawImage(j, c, i));
              else if ((a = K[a]) && !a.inited)
                l.setImage(a.id, a.src, a.benchId, a.bench, a.cache),
                  (a.inited = !0);
              return this;
            },
            ...
            drawCache: function (a, c, b, d, e, g, h, f, j, q) {
              if ((a = w[a]))
                null != f && ((c = 0 > c ? 0 : c), (f = 0 >= f ? 0.1 : f)),
                  null != j && ((b = 0 > b ? 0 : b), (j = 0 >= j ? 0.1 : j)),
                  null != d &&
                    null != f &&
                    (d = 0 >= d ? 0.1 : c + d <= a.width ? d : a.width - c),
                  null != e &&
                    null != j &&
                    (e = 0 >= e ? 0.1 : b + e <= a.height ? e : a.height - b),
                  d
                    ? e
                      ? q
                        ? ((G = l.getAnchor(g, h, f, j, q)),
                          k.drawImage(a, c, b, d, e, G.x, G.y, f, j))
                        : k.drawImage(a, c, b, d, e, g, h, f, j)
                      : ((G = l.getAnchor(c, b, a.width, a.height, d)),
                        k.drawImage(a, G.x, G.y))
                    : k.drawImage(a, c, b);
              return this;
            },
            drawRegion: function (a, c, b, d, e, g, h, f) {
              ...
              (!m.getImage(a).cache ? this.drawImage : this.drawCache)(
                a,
                c,
                b,
                d,
            ...
            measureText: function (a) {
              var c = k.measureText(a),
                b = c.width,
                c = c.height ? c.height : parseInt(k.font);
              return {
                width: "j2me" == this.screen.getDevice() ? k.measureText(a) : b,
                height: c,
              };
            },
            ...
            drawString: function (a, c, d, e, f, h, j, q) {
              ...
              if (e)
                switch (e) {
                  ...
                  case 2:
                    g = parseInt(
                      (this.screen.getWidth() - this.measureText(a).width) >> 1
                    );
                    break;
                  case 8:
          ...
          pushImage: function (a) {
            ...
            for (var c, b = 0, d = a.length; b < d; b++)
              if ((c = a[b]) && !S[c.id]) (S[c.id] = !0), F.push(a[b]);
            return this;
          },
          loadImage: function (a) {
            if (f.gameFlow != z.loadImage && 0 < a.length) {
              ...
              F = a;
              J = F.length;
              for (var a = (q = 0), c; (c = F[a]); a++)
                u[c.id] ? q++ : l.setImage(c.id, c.src, c.benchId);
            }
            return this;
          },
          asyncImage: function (a) {
            for (var c, b = 0, d = a.length; b < d; b++)
              (c = a[b] || {}), K[c.id] || (K[c.id] = c);
            return this;
          },
          verImage: function (a) {
            "" == L && (L = a);
          ...
          delImage: function (a, c) {
            u[a] &&
              ((u[a] = null),
              delete u[a],
              c && (u[a] = { id: a, loaded: !0, cache: !0, refreshed: !0 }));
            return this;
          },
          ...
          clearAsyncImageCache: function () {
            try {
              ...
              for (b in u)
                if ((a = u[b]))
                  if ((c = K[b]))
                    (c.inited = !1), this.delImage(b).canvas.del(b);
            } catch (d) {}
            return this;
          },
          audio: {
            ...
            playRange: function (a, c, b) {
              if ((a = y[a]))
                try {
                  a.__timeupdateCallBack__ ||
                    a.addEventListener(
                      "timeupdate",
                      (a.__timeupdateCallBack__ = function () {
                        this.currentTime >= this.__to__ &&
                          (this.loop
                    ...
                    (a.__from__ = null == c ? 0 : c),
                    (a.__to__ = null == b ? a.duration : b),
            ...
            setCurrentTime: function (a, c) {
              ...
              if (b)
                try {
                  0 > c ? (c = 0) : c > b.duration && (c = b.duration),
                    (b.currentTime = c || 0);
                } catch (d) {}
              return this;
            },
          ...
          request: {
            init: function () {
              l.initUrlParams(
                window.leiyooHref ? window.leiyooHref : location.href
              );
            },
            get: function (a) {
              return da[a] ? da[a] : "";
  ...
  link.getScript = function (a) {
    ...
    "" != a.url &&
      ...
      (I.type = a.contentType),
      (I.async = !0),
      (I.src = a.url),
      (I.destroyed = a.destroyed),
      (ba = a.success),
      (ca = a.error),
      (I.onload = function () {
        ga();
  ...
  link.classes.Observer.prototype.notify = function (a) {
    for (var c = 0; c < this.group.length; c++)
      if (null != this.group[c]) this.group[c](a);
    return this;
  };
  ...
  link.classes.Timer.prototype.start = function (a) {
    ...
    this.timeout = setTimeout(
      function (a) {
        var b = Date.now(),
          d = parseInt(Math.round((b - a._dateTime) / a.millisec));
        a._dateTime = b;
        a.time -= d;
...
(function (g) {
  ...
  link.action.Role = function (b, e, n, h, j, p, s, t) {
    ...
    if (0 < p.length) {
      for (t = 0; t < p.length; t++) {
        for (var j = [], b = p[t].frames, w = 0; w < b.length; w++)
          j.push({ args: [b[w][0], b[w][1], b[w][2]], step: b[w][3] });
  ...
  link.action.Role.prototype.setSprite = function (b, e, n) {
    if (this._locked) return this;
    var h = void 0 != b ? b : 0,
      j = 0 <= h ? g.trans.TRANS_NONE : g.trans.TRANS_MIRROR;
    this._cr != h &&
      ((this._cr = h),
      0 > h && (h = Math.abs(h)),
      (this.current = h >= this.sprites.length ? this.sprites.length - 1 : h),
      1 < this.sprites.length && this.setTrans(j),
      (h = this.getSprite()),
      (j = h.getFrame()),
      e || h.setFrame(0),
      n && (this._stopedAction = this._cr),
      (h = this.frames[j.args[0]]),
      (this._fA = h.fA),
      (this.aR = h.aR),
      (this.bR = h.bR));
    ...
    if (e) {
      ...
      if (0 < this._path.length)
        (j = this._path.shift()),
          (h = j[0] || 0),
          (j = j[1] || 0),
          this._skipMoveDs || this.setSprite(this._moveDs[B(h, j)], !0),
          (this.svx = h),
          (this.svy = j),
        ...
        this._skipMoveDs ||
          (this.setSprite(
            this._stopedAction || this._stopDs[B(this.svx, this.svy)]
          ),
      ...
      0 < this._zooms.length &&
        ((g = this._zooms.shift()),
        "number" == typeof parseInt(g) && this.setZoom(g));
      0 < this._angles.length &&
        ((g = this._angles.shift()),
        "number" == typeof parseInt(g) && this.setRotate(g));
      this.x += e.args[1] + h;
      this.y += e.args[2] + j;
    }
    b.nextFrame();
    ...
    if (b && this._fA) {
      ...
      e[0] &&
        ...
        g.canvas
          ...
          .translate(-j, -p));
      for (var t = 0; t < n; t++)
        (j = this.rects[e[t][0]][e[t][1]]),
          (p = this.imageNames[e[t][0]]),
          (s = g.getImage(p)),
          b == g.trans.TRANS_NONE
            ? h.drawImage(
                p,
                j[0],
                j[1],
                ...
                j[3],
                1 == this.zoom
                  ? parseInt(this.x + this.dx + e[t][2] * this.zoom)
                  : this.x + this.dx + e[t][2] * this.zoom,
                1 == this.zoom
                  ? parseInt(this.y + this.dy + e[t][3] * this.zoom)
                  : this.y + this.dy + e[t][3] * this.zoom,
                j[2] * this.zoom,
                j[3] * this.zoom
              )
            : 1 == this.zoom
            ? h.drawRegion(
                ...
                j[3],
                b,
                parseInt(this.x + this.dx - (e[t][2] + j[2])),
                parseInt(this.y + this.dy + e[t][3])
              )
            : h.drawRegionAndZoom(
                p,
                j[0],
                ...
                j[3],
                b,
                this.x + this.dx - (e[t][2] + j[2]) * this.zoom,
                this.y + this.dy + e[t][3] * this.zoom,
                null,
                j[2] * this.zoom,
                j[3] * this.zoom
          ...
          !s.loaded &&
            s.bench &&
            h.drawImage(
              s.bench.id || s.benchId,
              s.bench.sx || 0,
              s.bench.sy || 0,
              s.bench.sw || s.bench.w,
              s.bench.sh || s.bench.h,
              parseInt(this.x + this.dx - ((s.bench.w * this.zoom) >> 1)),
              parseInt(this.y + this.dy - s.bench.h * this.zoom),
              s.bench.w * this.zoom,
              s.bench.h * this.zoom
            );
  ...
  link.action.Role.prototype.getBodyRect = function (b, e) {
    ...
    return (null == b && n.trans != g.trans.TRANS_NONE) || 0 > b
      ? [
          -(h[0] + h[2] * this.zoom),
          h[1] * this.zoom,
          h[2] * this.zoom,
  ...
  link.action.Role.prototype.setStep = function (b) {
    this.step = b || 0;
    for (var e = 0, g = this.sprites.length; e < g; e++)
      this.sprites[e].setStep(b);
    return this;
  };
  link.action.Role.prototype.collision = function (b, e, n) {
    ...
    return h && j
      ? g.comm.collision(
          this.getSprite().trans == g.trans.TRANS_NONE
            ? parseInt(this.x + this.dx + h[0] * this.zoom)
            : parseInt(this.x + this.dx - (h[0] + h[2]) * this.zoom),
          parseInt(this.y + this.dy + h[1] * this.zoom),
          parseInt(h[2] * this.zoom),
          parseInt(h[3] * this.zoom),
          b.getSprite().trans == g.trans.TRANS_NONE
            ? parseInt(b.x + b.dx + j[0] * b.zoom)
            : parseInt(b.x + b.dx - (j[0] + j[2]) * b.zoom),
          parseInt(b.y + b.dy + j[1] * b.zoom),
          parseInt(j[2] * b.zoom),
          parseInt(j[3] * b.zoom)
        )
      : !1;
  ...
  link.action.Role.prototype.collisionInput = function (b, e, n, h, j) {
    ...
    return p
      ? g.comm.collision(
          this.getSprite().trans == g.trans.TRANS_NONE
            ? parseInt(this.x + this.dx + p[0] * this.zoom)
            : parseInt(this.x + this.dx - (p[0] + p[2]) * this.zoom),
          parseInt(this.y + this.dy + p[1] * this.zoom),
          parseInt(p[2] * this.zoom),
          parseInt(p[3] * this.zoom),
          b,
          e,
          n,
          h
  ...
  link.action.Role.prototype.moveTo = function (b, e, n) {
    ...
    this.setPath(
      g.comm.createPath(this.mapOffx, this.mapOffy, b, e, this.speed)
    );
    return this;
  };
  ...
  link.action.Role.prototype.move = function (b, e) {
    null != b && (this.x += b);
    null != e && (this.y += e);
    return this;
  };
  ...
  link.action.Role.prototype.getCurrent = function () {
    return (
      this.current * (this.getSprite().trans == g.trans.TRANS_NONE ? 1 : -1)
    );
  };
  ...
  link.action.Sprite.prototype.setFrame = function (b) {
    this.current =
      b >= this.frames.length ? this.frames.length - 1 : 0 < b ? b : 0;
  ...
  link.action.Sprite.prototype.preFrame = function () {
    0 < this.frames.length &&
      (0 >= this.runStep
        ? (this.loop
            ? (this.current--,
              0 > this.current && (this.current = this.frames.length - 1))
  ...
  link.action.Sprite.prototype.endFrame = function (b) {
    ...
    null != b && 0 <= b && b <= this.frames.length - 1 && (e = b);
  ...
  link.action.Fragment.prototype.queue = function () {
    0 < this.sprites.length
      ? 0 < this.sprites[0].frames.length &&
        (0 >= this.sprites[0].runStep
          ? ((this.sprites[0].runStep = this.sprites[0].step),
            (C = this.sprites[0].frames.shift()),
            0 == this.sprites[0].frames.length && this.sprites.shift())
          : ((C = this.sprites[0].getFrame()), this.sprites[0].runStep--))
      : (C = null);
    return C;
  };
...
(function (g) {
  ...
  g.init(375, 550)
    .pushImage([
      { id: "bg1", src: "img/bg1.jpg" },
      { id: "bg2", src: "img/bg2.jpg" },
      { id: "s1", src: "img/s1.png?123" },
    ])
    .asyncImage([
      { id: "s2", src: "img/s2.png" },
      { id: "n1", src: "img/number1.png" },
      { id: "n2", src: "img/number2.png" },
    ]);
  C ||
    g.initAudio([{ id: "sound1", src: "sound1.mp3", loop: !1, preload: !0 }]);
  g.pageLoad(function () {
    var b, e, n, h, j, p, s, t;
    window.scrollTo(0, 1);
    var w, E;
    g.canvas.screen.setHeight(
      550 < window.innerHeight ? 550 : window.innerHeight
    );
    ...
    A = {
        ...
        null,
        {
          ...
          render: function () {
            ...
            if ("" != this.props.value) {
              ...
              g.canvas.drawString(
                this.props.value,
                parseInt(this.props.x + ((this.props.width - b.width) >> 1)),
                parseInt(this.props.y + ((this.props.height - b.height) >> 1)) +
                  b.height -
                  2,
                "",
                !0,
      ...
      getButton: function (b) {
        for (var d, e = D.length - 1; 0 <= e; e--)
          if (((d = D[e]), d.id == b)) return d;
        return null;
      },
      ...
      actionButton: function (b, d, e) {
        for (var f, g = D.length - 1; 0 <= g; g--)
          (f = D[g]), f.collision(d, e, 1, 1, b);
        return this;
      },
    ...
    var B = g.canvas.screen.getDevice(),
      x = {
        ...
        setBg: function (b) {
          ...
          g.canvas
            .pass("bgCache", this.bgWidth, this.bgHeight)
            .drawImage(b, 0, this.bgHeight - this.bgImgH)
            .drawImage(b, this.bgImgW, this.bgHeight - this.bgImgH)
            .pass();
          return this;
        },
        bgRender: function () {
          g.canvas
            ...
            .fillScreen()
            .drawCache("bgCache", this.bgX, this.bgY);
          return this;
        },
        gameOver: function () {
          this.screenFade();
        ...
        screenFade: function () {
          this.isGameOver ||
            ...
            g.audio.pauseAll().playRange("sound1", 5, 6),
            window.dp_submitScore &&
              dp_submitScore(
                g.localStorage.getItem("FlappyBirdBestScore"),
                x.score
              ));
          return this;
        },
        ...
        popObs: function () {
          var b = g.comm.getRandom(60, 170),
            d = this.obsMapping.mp1,
            e = this.obsMapping.mp2;
          this.obses.push({
            id: g.getNewGuid(),
            x: w,
            y: -(d.height - b),
        ...
        objesAction: function () {
          ...
          switch (this.obsState) {
            case "ready":
              ...
              break;
            case "run":
              for (var b = this.obses.length - 1, d; (d = this.obses[b]); b--)
                (d.x += this.speed),
                  this.bird.collisionInput(d.x, d.y, d.width, d.height, "bR") &&
                    this.gameOver(),
                  -52 >= d.x && this.obses.splice(b, 1);
              this.obsCurrentFrame++ == this.obsFrameNum &&
                ((this.obsCurrentFrame = 0),
                (this.obsDate = _newDate),
                this.popObs());
          }
          if (
            (b = this.obses[0]) &&
            b.id != this.scoreObsId &&
            b.x < this.bird.x - 26
          )
            (this.scoreObsId = b.id), this.score++;
          return this;
        },
        objesRender: function () {
          for (var b, d = 0, e; (e = this.obses[d]); d++)
            (b = e.imgObj),
              g.canvas.drawImage(
                b.id,
                b.sx,
        ...
        setBird: function (b, d, e) {
          ...
          this.bird
            .mark(d || 88, e || this.bgHeight - 246)
            .setSprite(b)
            .setStep(2)
            .setRotate(0)
            .setLoop(!0).state = "waiting";
          this.vy = 0;
          return this;
        },
        birdJump: function () {
          this.isGameOver ||
            ((this.vy = this.jumpSpeed), g.audio.playRange("sound1", 0, 1));
          return this;
        },
        birdAction: function () {
          if (this.bird)
            switch ((this.bird.action(), this.bird.state)) {
              case "waiting":
                this.bird.endPath() &&
                  this.bird.setPath(
                    [
              ...
              case "flying":
                this.vy += this.g;
                if (
                  this.bird.collisionInput(
                    0,
                    this.bgHeight - this.landH - this.vy,
                    this.landW,
                    this.landH,
                    "bR"
                  )
        ...
        landInit: function () {
          this.landX = 0;
          this.landY = this.bgHeight - this.landH;
          g.canvas
            .pass("landCache", this.landW, this.landH)
            .drawImage("s1", 0, 0, 336, 112, 0, 0, 336, 112)
            .drawImage("s1", 0, 0, 336, 112, 336, 0, 336, 112)
            .pass();
          return this;
        },
        landAction: function () {
          ...
          this.landX =
            this.landX < this.landW - this.bgWidth - this.speed
              ? 0
              : this.landX;
          return this;
        },
        ...
        screenFlushRender: function () {
          0 < this.screenFlush.length &&
            (g.canvas
              .fillStyle(
                "rgba(255, 255, 255, " + this.screenFlush.shift() + ")"
              )
              .fillScreen(),
            0 == this.screenFlush.length &&
              (g.audio.playRange("sound1", 7, 8),
              A.clearButtons(),
              (b = 0),
              (e = -1),
              (g.localStorage.getItem("FlappyBirdBestScore") || 0) < x.score
                ? (g.localStorage.setItem("FlappyBirdBestScore", x.score),
                  (n = !0))
                : (n = !1),
              (h = parseInt(
                g.localStorage.getItem("FlappyBirdBestScore") || 0
              )),
              (j = d),
              (p = [-3, -2, -1, 1, 2, 3]),
              (s = d + 500),
              (t = [-200, -100, -70, -40, -20, -10, -5]),
              (u = A.appendButton({
                id: "playBtn",
                x: f + 100,
                y: d + 180,
      ...
      J = {
        ...
        action: function () {
          0 < this.values.length &&
            ((this.opacity = this.values.shift()),
            0 == this.values.length && this.callBack && this.callBack());
          return this;
        },
        render: function () {
          0 < this.opacity &&
            g.canvas
              .fillStyle("rgba(0, 0, 0, " + this.opacity + ")")
              .fillScreen();
          return this;
        },
      };
    ...
    g.run(function () {
      ...
      .zone(function () {
        x.birdAction()
          ...
          .scoreRender();
        g.canvas
          .drawImage("s1", 2, 118, 192, 58, f + 54, d, 192, 58)
          .drawImage("s1", 0, 182, 114, 98, f + 93, E - 280, 114, 98);
        J.action().render();
      })
      .over(function () {
        x.birdAction().bgRender().birdRender().landRender();
        g.canvas
          .drawImage("s1", 202, 118, 200, 50, f + 50, j, 200, 50)
          .drawImage("s2", 2, 2, 234, 122, f + 33, s, 234, 122);
        switch (b) {
          case 0:
            0 < p.length
              ? (j += p.shift())
        ...
        0 <= e &&
          g.canvas
            .drawNumber(e, "n2", 14, 20, f + 240, d + 90, !1)
            .drawNumber(h, "n2", 14, 20, f + 240, d + 130, !1);
        u &&
          u.released() &&
          J.fadeIn(function () {
            S();
